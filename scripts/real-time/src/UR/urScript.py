...
class UrScript(object):
    ...
    def __init__(self, host, robotModel, hasForceTorque=False, conf_filename=None):
        ...
        self.robotConnector = UR.robotConnector.RobotConnector(robotModel, host, hasForceTorque, conf_filename=conf_filename)
        #time.sleep(200)
...
############    Module urmath    #################
    ...
    def pose_add(p_1, p_2):
        ...
        '''
        Trans_1 = UR.kinematic.Pose2Tran_Mat(p_1)
        Trans_2 = UR.kinematic.Pose2Tran_Mat(p_2)
        Trans_3 = np.matmul(Trans_1, Trans_2)
        p_3 = UR.kinematic.Tran_Mat2Pose(Trans_3)
